const areaData: Record<string, string[]> = {
	...
	"南投縣": ["南投市", "埔里鎮", "草屯鎮", "竹山鎮", "集集鎮", "名間鄉", "中寮鄉", "國姓鄉", "水里鄉", "魚池鄉", "信義鄉", "仁愛鄉", "鹿谷鄉"],
	"雲林縣": ["斗六市", "斗南鎮", "虎尾鎮", "西螺鎮", "土庫鎮", "北港鎮", "林內鄉", "古坑鄉", "大埤鄉", "莿桐鄉", "崙背鄉", "二崙鄉", "麥寮鄉", "東勢鄉", "褒忠鄉", "台西鄉", "元長鄉", "四湖鄉", "口湖鄉", "水林鄉"],
...
export const getDistricts = (city: string): string[] | undefined => {
